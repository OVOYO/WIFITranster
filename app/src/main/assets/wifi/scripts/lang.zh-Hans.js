...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到 WiFiTransfer 的文件';
STRINGS.SUPPORTED_FILE_TYPES = '';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接 WiFiTransfer 服务器，请重新打开 WiFiTransfer 服务并刷新此页后重新上传。';
